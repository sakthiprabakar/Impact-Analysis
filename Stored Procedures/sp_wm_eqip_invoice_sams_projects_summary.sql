...
CREATE PROCEDURE sp_wm_eqip_invoice_sams_projects_summary (
	@invoice_code varchar(16)
)
AS
/* *************************************
sp_wm_eqip_invoice_sams_projects_summary
...
sp_wm_eqip_invoice_sams_projects_summary '40283596'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_summary] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_summary] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_summary] TO [EQAI]
    AS [dbo];
