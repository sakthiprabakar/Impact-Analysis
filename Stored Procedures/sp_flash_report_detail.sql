CREATE PROCEDURE sp_flash_report_detail  
	@company_id		int
,	@profit_ctr_id	int
,	@date_from		datetime
,	@date_to		datetime
...
Filename:	L:\Apps\SQL\EQAI\sp_flash_report_detail.sql
PB Object(s):	d_rpt_flash_report_detail

06/19/1999 SCC	Created
09/18/1999 LJT	Added join to Resourceclass table by unit to allow the multiple resources per unit
01/28/1999 LJT	Added the check for qd.group_code = '' and removed the match on quote profit center id.
...
09/23/2010 SK	Moved to run on Plt_AI, added input arg Company_ID
...
sp_flash_report_detail 14, -1, '06-01-2006 00:00:00','06-30-2006 23:59:59', 1, 999999, '99', 1
***********************************************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_flash_report_detail] TO [EQAI]
    AS [dbo];
