...
declare
	...
	@customer_id_list	varchar(8000),
	@cust_name			varchar(40),
	@territory_list		varchar(8000),
	@city				varchar(40),
	@state				varchar(8000),
	@zip_from			varchar(10),
	@zip_to				varchar(10),
	@phone				varchar(20),
	@fax					varchar(20),
	@terms_code			varchar(8000),
	@customer_type		varchar(8000),
...
exec spw_MailingList2 @company_list, @customer_id_list, @cust_name, @territory_list, @city, @state, 
...
CREATE	PROCEDURE	spw_MailingList2	(
	@company_list		varchar(8000)	=	NULL,
	@customer_id_list	varchar(8000)	=	NULL,
	@cust_name			varchar(40)		=	NULL,
	@territory_list		varchar(8000)	=	NULL,
...
as
	...
	declare @sql varchar(8000), @intCount int
	...
	set @sql = '
			select distinct
				...
				c.cust_name,
				co.name,
				case when co.email_flag <> ''t'' then null else co.email end as email,
				c.cust_addr1,
				c.cust_addr2,
				c.cust_addr3,
				c.cust_addr4,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_MailingList2] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_MailingList2] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_MailingList2] TO [EQAI]
    AS [dbo];
