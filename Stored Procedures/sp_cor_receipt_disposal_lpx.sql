-- 
drop procedure if exists sp_cor_receipt_disposal_lpx
go

create procedure sp_cor_receipt_disposal_lpx (
...
exec sp_cor_receipt_disposal_lpx
...
grant execute on sp_cor_receipt_disposal_lpx to eqai, eqweb, COR_USER
go
