...
create proc sp_reports_GE_generator_actionregister_master (
...
as
/* ****************************************************************************
sp_reports_GE_generator_actionregister_master
...
exec sp_reports_GE_generator_actionregister_master
	@ReportType				= 'ALL'	--'All'
	, @StatusList			= 'ALL'
	, @customer_id_list		= '-1'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_actionregister_master] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_actionregister_master] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_actionregister_master] TO [EQAI]
    AS [dbo];
