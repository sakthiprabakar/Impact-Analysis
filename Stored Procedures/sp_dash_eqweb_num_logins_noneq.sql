...
CREATE PROCEDURE sp_dash_eqweb_num_logins_noneq
	@measurement_id	int,
	@start_date		datetime,
	@end_date		datetime
AS
/* ************************************************
sp_dash_eqweb_num_logins_noneq:
...
examples:
	...
	sp_dash_eqweb_num_logins_noneq 9, '2009-06-15 00:00:00', '2009-06-15 23:59:59'
	select * 
	...
	update dashboardmeasurement set 
		...
		where measurement_id = 9
	sp_dash_eqweb_num_logins_noneq 9, '2009-01-15 00:00:00', '2009-01-15 23:59:59'
	select * 
		from DashboardResult 
...
10/14/2009 RJG Verified date_added is used & correct
************************************************ */
...
FROM DashboardMeasurement dm
	...
	LEFT OUTER JOIN EQWeb..b2blog a ON a.date_added BETWEEN @start_date AND @end_date AND a.action like 'Customer Logged In'
WHERE 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_eqweb_num_logins_noneq] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_eqweb_num_logins_noneq] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_eqweb_num_logins_noneq] TO [EQAI]
    AS [dbo];
