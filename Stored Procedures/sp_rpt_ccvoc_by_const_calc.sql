...
Filename:	L:\Apps\SQL\EQAI\sp_rpt_ccvoc_by_const_calc.sql
...
07/14/2015 SK	Renamed the sp to sp_rpt_ccvoc_by_const_calc. This will be used as a calculated version. The value for CCVOC 
				will not be taken from profile but will be system calculated.
05/17/2022 MPM	DevOps 27251 - Modified the calculation of emissions to be the same as in the HAP Report (DevOps 17534).
06/29/2022 GDE DevOps 42729 - CCVOC By Constituent Worksheet (Calculated) - Report update
...
sp_rpt_ccvoc_by_const_calc 21, 0, '01/01/2021', '01/07/2021', 'ALL', -99, -99
***********************************************************************/
...
*/
UPDATE #tri_work_table 
SET pounds_constituent = Round ( dbo.fn_calculate_constituents_worksheet_ccvoc (company_id,profit_ctr_id,receipt_id,line_id,const_id) , 5 ) 
