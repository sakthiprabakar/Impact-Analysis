...
CREATE PROCEDURE sp_wm_eqip_invoice_wm_projects_summary (
	@invoice_code varchar(16)
)
AS
/* *************************************
sp_wm_eqip_invoice_wm_projects_summary
...
sp_wm_eqip_invoice_wm_projects_summary '40488370'

invoice_code      invoice_id invoice_date            Vendor_Number              Material                 Labor    Shipping      Invoice_SubTotal                   Tax    Total_Invoice_Cost terms_desc                        days_due min_service_date        max_service_date        invoice_type
---------------- ----------- ----------------------- ------------- --------------------- --------------------- ----------- --------------------- --------------------- --------------------- ------------------------------ ----------- ----------------------- ----------------------- ------------
40488370              962187 2013-10-11 00:00:00.000        257170             629212.92             461105.85           0            1090318.77                 18.15            1095624.89 Net 30                                  30 2013-09-03 00:00:00.000 2013-10-04 00:00:00.000 Walmart

SELECT * FROM invoiceheader where invoice_code = '40488370'
1095624.89
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_wm_projects_summary] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_wm_projects_summary] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_wm_projects_summary] TO [EQAI]
    AS [dbo];
