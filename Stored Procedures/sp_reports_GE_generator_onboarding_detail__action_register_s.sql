...
create proc sp_reports_GE_generator_onboarding_detail__action_register_s (
	@generator_id		int
	, @status_list		varchar(max) = 'all'
)
as
/* ****************************************************************************
sp_reports_GE_generator_onboarding_detail__action_register_s
...
sp_reports_GE_generator_onboarding_detail__action_register_s 169151
**************************************************************************** */
...
-- Action Register: Supplier Corrective Action Report
	...
	--                CASE ar.view_on_web WHEN 'T' THEN 'Yes' WHEN 'F' THEN 'No' END AS 'view_on_web',
		ar.scar_start_date AS 'start_date',
		ar.scar_target_completion_date AS 'target_completion_date',
		ar.scar_actual_completion_date AS 'actual_completion_date',
		ar.scar_vendor_name AS 'vendor_name'
	...
	WHERE art.action_type = 'Supplier Corrective Action Report'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_s] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_s] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_s] TO [EQAI]
    AS [dbo];
