...
create proc sp_reports_GE_generator_onboarding_detail__timeline (
	@generator_id		int
)
as
/* ****************************************************************************
sp_reports_GE_generator_onboarding_detail__timeline
...
sp_reports_GE_generator_onboarding_detail__timeline 168770
**************************************************************************** */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__timeline] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__timeline] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__timeline] TO [EQAI]
    AS [dbo];
