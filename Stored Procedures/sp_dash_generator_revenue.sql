drop proc if exists sp_dash_generator_revenue
go

Create procedure sp_dash_generator_revenue (
    @start_date    datetime,
    @end_date      datetime,
...
02/16/204 - PP - 78899 - Include the 'County' column in the result set
09/06/204 - PP - 79190 - Add 'Project ID' to be a column output 
...
LEFT JOIN BillingDetail bd ON billing.billing_uid = bd.billing_uid
