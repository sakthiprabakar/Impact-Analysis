...
CREATE PROCEDURE sp_rpt_extract_walmart_disposal_finance_summary1 (
    @start_date             datetime,
    @end_date               datetime
)
AS
/-* ***********************************************************
Procedure    : sp_rpt_extract_walmart_disposal_finance_summary1
Database     : PLT_AI
Created      : Jan 25 2008 - Jonathan Broome
Description  : Creates a Wal-Mart Disposal Extract

Examples:
    sp_rpt_extract_walmart_disposal_finance_summary1 '1/1/2009 00:00', '1/31/2009 23:59'
    sp_rpt_extract_walmart_disposal_finance_summary1 '3/1/2009 00:00', '3/30/2009 23:59'
    sp_rpt_extract_walmart_disposal_finance_summary1 '1/1/2010 00:00', '1/31/2010 23:59'
    sp_rpt_extract_walmart_disposal_finance_summary1 '8/1/2010', '8/31/2010'
...
History:
	...
	5/6/2011 - JPB
		1. sp_rpt_extract_walmart_disposal_finance_summary1 created from sp_rpt_extract_walmart_disposal
