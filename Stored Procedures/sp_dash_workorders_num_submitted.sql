...
CREATE PROCEDURE sp_dash_workorders_num_submitted
	@measurement_id	int,
	@start_date		datetime,
	@end_date		datetime
AS
/* ************************************************
sp_dash_workorders_num_submitted:
...
-- 38
	...
	sp_dash_workorders_num_submitted 38, '2009-09-10 00:00:00', '2009-09-10 23:59:59'
	select * 
...
10/06/2009 JPB Removed DashboardMeasurementProfitcenter join
				Added workorder_status check
10/14/2009 RJG Verified date_submitted is correct one to use				
...
SELECT
	...
	convert(varchar(20), count(w.workorder_id)) AS answer,
	NULL AS note,
	dm.threshold_value,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_submitted] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_submitted] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_submitted] TO [EQAI]
    AS [dbo];
