...
CREATE PROCEDURE sp_dash_volume_total_wastetype_category_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
/************************************************************
Procedure    : sp_dash_volume_total_wastetype_category_profitcenter
Database     : PLT_AI
...
sp_dash_volume_total_wastetype_category_profitcenter
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_category_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_category_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_category_profitcenter] TO [EQAI]
    AS [dbo];
