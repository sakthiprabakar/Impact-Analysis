...
CREATE PROCEDURE sp_wm_eqip_invoice_all_projects_description (
	@invoice_code varchar(16)
)
AS
/* *************************************
sp_wm_eqip_invoice_all_projects_description
...
sp_wm_eqip_invoice_all_projects_description '40488370'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_all_projects_description] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_all_projects_description] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_all_projects_description] TO [EQAI]
    AS [dbo];
