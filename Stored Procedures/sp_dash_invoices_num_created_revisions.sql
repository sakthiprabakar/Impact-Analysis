...
CREATE PROCEDURE sp_dash_invoices_num_created_revisions
	@measurement_id	int,
	@start_date		datetime,
	@end_date		datetime
AS
/* ************************************************
sp_dash_invoices_num_created_revisions:
...
Number of rev 1 invoices (revisions > 1) created per day

select * from DashBoardMeasurement where description like '%invo%'
-- 30

	sp_dash_invoices_num_created_revisions 30, '2009-09-10 00:00:00', '2009-09-10 23:59:59'
	select *
		from DashboardResult
		where report_period_end_date = '2009-09-10 00:00:00.000'
		and measurement_id = 30
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_invoices_num_created_revisions] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_invoices_num_created_revisions] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_invoices_num_created_revisions] TO [EQAI]
    AS [dbo];
