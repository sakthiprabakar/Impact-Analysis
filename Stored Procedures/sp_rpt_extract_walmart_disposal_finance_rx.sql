...
CREATE PROCEDURE sp_rpt_extract_walmart_disposal_finance_rx (
    @start_date             datetime,
    @end_date               datetime,
...
AS
/-* ***********************************************************
Procedure    : sp_rpt_extract_walmart_disposal_finance_rx
Database     : PLT_AI
Created      : Jan 25 2008 - Jonathan Broome
Description  : Creates a Wal-Mart Disposal Extract

Examples:
    sp_rpt_extract_walmart_disposal_finance_rx '1/1/2009 00:00', '1/31/2009 23:59', 'validation'
    sp_rpt_extract_walmart_disposal_finance_rx '3/1/2009 00:00', '3/30/2009 23:59', 'eq-extract'
    sp_rpt_extract_walmart_disposal_finance_rx '1/1/2010 00:00', '1/31/2010 23:59', 'wm-extract'
    sp_rpt_extract_walmart_disposal_finance_rx '8/1/2010', '8/31/2010', 'eq-extract'
...
History:
	...
	5/6/2011 - JPB
		1. sp_rpt_extract_walmart_disposal_finance_rx created from sp_rpt_extract_walmart_disposal
...
WHERE cb.billing_project_id IN (
	SELECT convert(int, row) from dbo.fn_SplitXsvText(' ', 1, '3636 3998 3999')
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal_finance_rx] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal_finance_rx] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal_finance_rx] TO [EQAI]
    AS [dbo];
