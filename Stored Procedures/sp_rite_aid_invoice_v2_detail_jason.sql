--CREATE PROCEDURE sp_rite_aid_invoice_v2_detail_jason (
--	  @customer_id			int
...
--01/21/2013 JPB	Copied this to sp_rite_aid_invoice_v2_detail_jason from sp_rite_aid_invoice
...
--EXECUTE sp_rite_aid_invoice_v2_detail_jason 14231, null, null, '1/27/13', '1/29/13'
...
----EXECUTE sp_rite_aid_invoice_v2_detail_jason 14232, '40402256', '40402256', '9/10/12', '9/11/12'
----EXECUTE sp_rite_aid_invoice_v2_detail_jason 14232, '40402257', '40402257', '9/10/12', '9/11/12'
----EXECUTE sp_rite_aid_invoice_v2_detail_jason 14232, '40402258', '40402258', '9/10/12', '9/11/12'
----EXECUTE sp_rite_aid_invoice_v2_detail_jason 14232, '40402260', '40402260', '9/10/12', '9/11/12'
...
--EXECUTE sp_rite_aid_invoice_v2_detail_jason 14231, '94437', '94437', '8/28/2014', '8/30/2014'
--*************************************************************************************************/
...
------------------------------------------------------------------------------------------------------------------------------
---- This code was added to capture the output of the stored procedure to a table for posterity and comparison.
------------------------------------------------------------------------------------------------------------------------------
--declare @date_added datetime = getdate()

--if not exists (select 1 from sysobjects where name = 'jdb_rite_aid_invoice_v2_detail_jason_saves')
--	SELECT 
--	@date_added as meta_date_added
--	, @customer_id as meta_input_customer_id
--	, @invoice_code_from as meta_input_invoice_code_from
--	, @invoice_code_to as meta_input_invoice_code_to
--	, @invoice_date_from as meta_input_invoice_date_from
--	, @invoice_date_to as meta_input_invoice_date_to
--	, *
--	INTO jdb_rite_aid_invoice_v2_detail_jason_saves
--	FROM #tmpOutput
--	WHERE special_invoice_amt > 0
--	ORDER BY generator_state, invoice_id, generator_city, invoice_sequence
--else
--	insert jdb_rite_aid_invoice_v2_detail_jason_saves
--	SELECT
--	@date_added as meta_date_added
--	, @customer_id as meta_input_customer_id
--	, @invoice_code_from as meta_input_invoice_code_from
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_rite_aid_invoice_v2_detail_jason] TO [EQWEB]
--    AS [dbo];
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_rite_aid_invoice_v2_detail_jason] TO [COR_USER]
--    AS [dbo];
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_rite_aid_invoice_v2_detail_jason] TO [EQAI]
--    AS [dbo];
