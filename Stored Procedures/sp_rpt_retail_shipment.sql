...
CREATE PROCEDURE sp_rpt_retail_shipment 
	@company_id			int
,	@profit_ctr_id		int
,	@date_from			datetime
,	@date_to			datetime
...
/***********************************************************************
PB Object(s):	r_retail_shipment
	
11/02/2010 SK	Created on Plt_AI

sp_rpt_retail_shipment 14, -1, '05/01/2010', '05/31/2010', 1, 999999, '0', 'zzzzzzz', 1, 99999, 'XX'
***********************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_retail_shipment] TO [EQAI]
    AS [dbo];
