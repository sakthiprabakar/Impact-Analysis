CREATE PROCEDURE sp_cert_disposition_foreign_generators 
	@profit_ctr_id		int,
	@company_id          int,
	@date_from			datetime, 
	@date_to			datetime, 
...
This report only applies to and only includes foreign generators.

01/05/2018	MPM	Created; copied from sp_cert_disposition.
01/22/2018	MPM	GEM 47742 - Added @foreign_permit and @consent input parameters; added foreign_permit and receipt_date to result set.
11/11/2019	MPM DevOps 12600 - Uncommented code that sets the list of disposal dates and print_stmt.
06/03/2023 Dipankar #39159 - Added arg_receipt_id argument and added logic to filter records for arg_receipt_id

sp_cert_disposition_foreign_generators 0, 21, '1/1/2017','1/5/2018', 0,999999,'0','zzzzzz', '0','zzzzzz', 0,99999, '0','ZZ', 'A',1, 0 
sp_cert_disposition_foreign_generators 0, 21, '1/1/2000','1/1/2050', 0,999999,'010202070JJK','010202070JJK', '0','zzzzzz', 0,99999, '0','ZZ', 'A',1, 0 
sp_cert_disposition_foreign_generators 0, 21, '1/1/2017','1/1/2018', 0,999999,'0','zzzzzz', '0','zzzzzz', 0,99999, '0','ZZ', 'A',1, null, null, 0 
sp_cert_disposition_foreign_generators 0, 21, '1/1/2017','1/1/2018', 0,999999,'0','zzzzzz', '0','zzzzzz', 0,99999, '0','ZZ', 'A',1, 'mpm test', null, 0 
sp_cert_disposition_foreign_generators 0, 3, '1/1/2017','11/11/2019', 0,999999,'0','zzzzzz', '0','zzzzzz', 0,99999, '0','ZZ', 'A',1, null, null, 0 
...
,	print_stmt				tinyint		-- 1=TSCA, 2=recycle stmt, 3=disposal stmt
...
AND IsNull ( Generator.foreign_generator_flag, 'F' ) = 'T' 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cert_disposition_foreign_generators] TO [EQAI]
    AS [dbo];
