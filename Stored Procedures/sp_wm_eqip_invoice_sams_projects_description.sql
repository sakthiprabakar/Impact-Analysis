...
CREATE PROCEDURE sp_wm_eqip_invoice_sams_projects_description (
	@invoice_code varchar(16)
)
AS
/* *************************************
sp_wm_eqip_invoice_sams_projects_description
...
sp_wm_eqip_invoice_sams_projects_description '40283596'
...
AND ih.status = 'I'
and bp.project_name like 'Sams Club%'
group by 
	ih.invoice_code
	, ih.invoice_id
	, ih.invoice_date
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_description] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_description] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_wm_eqip_invoice_sams_projects_description] TO [EQAI]
    AS [dbo];
