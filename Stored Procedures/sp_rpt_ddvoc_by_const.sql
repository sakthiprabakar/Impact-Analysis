DROP PROCEDURE IF EXISTS [dbo].[sp_rpt_ddvoc_by_const]
GO

CREATE PROCEDURE sp_rpt_ddvoc_by_const
	@company_id			int
,	@profit_ctr_id		int
,	@date_from			datetime
,	@date_to			datetime
...
04/14/2022 MPM	DevOps 27260 - Corrected the calculation of emissions.
...
sp_rpt_ddvoc_by_const 2, 21, '01/01/2008', '03/31/2008', 'ALL' , -99, 11
***********************************************************************/
...
/*	MPM - 4/14/2022 - DevOps 27260 - Corrected the calculation of pounds_emission.  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_ddvoc_by_const] TO [EQAI]
    AS [dbo];
