...
CREATE PROCEDURE sp_cert_copd_main
		@profit_center int, 
		@company_id int, 
		@date_from datetime, 
		@date_to datetime, 
...
sp_cert_copd_main 0, '10/24/2007', '10/29/2007', 0, 999999, '0', 'zzz', '0', 'zzz', 0,999999,'0','zzz',1,0
****************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cert_copd_main] TO [EQAI]
    AS [dbo];
