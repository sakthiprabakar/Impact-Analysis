...
CREATE PROCEDURE sp_dash_receipts_nonbulk_num_received
	@measurement_id	int,
	@start_date		datetime,
	@end_date		datetime
AS
...
-- 27
	...
	exec sp_dash_receipts_nonbulk_num_received 65, '01/05/2011', '01/10/2011 23:59:59'
	sp_dash_receipts_nonbulk_num_received 27, '2009-09-10 00:00:00', '2009-09-10 23:59:59'
	select * 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_receipts_nonbulk_num_received] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_receipts_nonbulk_num_received] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_receipts_nonbulk_num_received] TO [EQAI]
    AS [dbo];
