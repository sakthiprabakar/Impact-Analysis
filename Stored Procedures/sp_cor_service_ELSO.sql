-- 
drop proc if exists sp_cor_service_ELSO
go
create procedure sp_cor_service_ELSO (
...
grant execute on sp_cor_service_ELSO to eqai, eqweb, COR_USER
go
