...
create proc sp_reports_waste_ranking_master (
...
as
/* ****************************************************************************
sp_reports_waste_ranking_master
...
exec sp_reports_waste_ranking_master
...
-- Setup is finished.  On to work:
	...
	select distinct
		...
		, @customer_id_list as customer_id_list
		, @generator_id_list as generator_id_list
		, @site_type_list as site_type_list
		, @generator_state_list as generator_state_list
		, @generator_country_list as generator_country_list
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_waste_ranking_master] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_waste_ranking_master] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_waste_ranking_master] TO [EQAI]
    AS [dbo];
