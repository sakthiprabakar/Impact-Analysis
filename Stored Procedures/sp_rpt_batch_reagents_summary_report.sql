...
CREATE PROCEDURE sp_rpt_batch_reagents_summary_report
	@company_id		int
,	@profit_ctr_id 	int
,	@date_from		datetime
,	@date_to		datetime
AS
/***************************************************************************************
r_batch_reagents_summary_report

05/2/2018 AM	Created

sp_rpt_batch_reagents_summary_report 45, 0,  '1/1/2018', '3/1/2018'
...
--Batch Reagents Used - Summary by Reagent
select be.reagent_desc as reagent_desc, 
...
where 
	...
	and b.status <> 'V'
group by be.reagent_desc, be.unit, bu.pound_conv, bu.pound_conv 
order by be.reagent_desc


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_batch_reagents_summary_report] TO [EQAI]
    AS [dbo];
