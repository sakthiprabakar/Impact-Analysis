-- drop proc if exists sp_cor_billing_summary
go

CREATE PROCEDURE [dbo].[sp_cor_billing_summary]
...
12/02/2019 JPB - Copied to sp_cor_billing_summary from sp_reports_billing_summary_master and customized
...
Grant execute on sp_cor_billing_summary to EQAI
go
Grant execute on sp_cor_billing_summary to EQWEB
go
Grant execute on sp_cor_billing_summary to COR_USER
go
