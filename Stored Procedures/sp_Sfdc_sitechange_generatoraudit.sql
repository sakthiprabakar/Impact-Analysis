...
GO
CREATE OR ALTER procedure [dbo].[sp_Sfdc_sitechange_generatoraudit]
						@generator_id int,
...
GRANT EXECUTE ON OBJECT::[dbo].[sp_Sfdc_sitechange_generatoraudit] TO EQAI  
 
Go
 
GRANT EXECUTE ON OBJECT::[dbo].[sp_Sfdc_sitechange_generatoraudit] TO svc_CORAppUser
