...
CREATE PROCEDURE sp_rpt_retail_returns 
	@company_id			int
,	@profit_ctr_id		int
,	@date_from			datetime
,	@date_to			datetime
...
/***********************************************************************
PB Object(s):	r_retail_returns
	
11/09/2010 SK	Created on Plt_AI

sp_rpt_retail_returns 14, -1, '05/01/2010', '05/31/2010', 1, 999999, '0', 'zzzzzzz', 1, 99999, 'XX'
***********************************************************************/
...
JOIN OrderItem
	...
	AND OrderItem.date_returned BETWEEN @date_from AND @date_to
JOIN Product
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_retail_returns] TO [EQAI]
    AS [dbo];
