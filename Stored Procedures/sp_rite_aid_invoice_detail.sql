CREATE PROCEDURE sp_rite_aid_invoice_detail (
	  @customer_id			int
...
01/21/2013 JPB	Copied this to sp_rite_aid_invoice_detail from sp_rite_aid_invoice
...
EXECUTE sp_rite_aid_invoice_detail 14231, '40426423', '40426423', '1/1/12', '12/31/13', 1
...
--EXECUTE sp_rite_aid_invoice_detail 14232, '40402256', '40402256', '9/10/12', '9/11/12'
--EXECUTE sp_rite_aid_invoice_detail 14232, '40402257', '40402257', '9/10/12', '9/11/12'
--EXECUTE sp_rite_aid_invoice_detail 14232, '40402258', '40402258', '9/10/12', '9/11/12'
--EXECUTE sp_rite_aid_invoice_detail 14232, '40402260', '40402260', '9/10/12', '9/11/12'
...
--		END AS receipt_id
	...
	, rcb.stop_fee_price as resource_unit_price
...
JOIN InvoiceHeader ih ON ih.invoice_id = t.invoice_id
...
FROM #tmpOutput
WHERE special_invoice_amt > 0
ORDER BY invoice_id, generator_city, generator_state, invoice_sequence
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rite_aid_invoice_detail] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rite_aid_invoice_detail] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rite_aid_invoice_detail] TO [EQAI]
    AS [dbo];
