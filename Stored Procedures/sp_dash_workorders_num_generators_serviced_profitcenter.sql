...
CREATE PROCEDURE sp_dash_workorders_num_generators_serviced_profitcenter
	@measurement_id	int,
	@start_date		datetime,
	@end_date		datetime
AS
/* ************************************************
sp_dash_workorders_num_generators_serviced_profitcenter:
...
-- 47
	...
	sp_dash_workorders_num_generators_serviced_profitcenter 47, '2009-09-10 00:00:00', '2009-09-10 23:59:59'
	select *
...
10/14/2009 RJG Verified start_date is to be used
************************************************ */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_generators_serviced_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_generators_serviced_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_workorders_num_generators_serviced_profitcenter] TO [EQAI]
    AS [dbo];
