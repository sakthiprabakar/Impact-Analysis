...
CREATE PROCEDURE sp_biennial_report_output_OH_GM (
	@biennial_id	int
)
AS
/* **********************************************************************************
...
INSERT EQ_Extract..BiennialReportWork_OH_GM1
SELECT DISTINCT
...
set @intcounter = 0
update EQ_Extract..BiennialReportWork_OH_GM1
...
INSERT EQ_Extract..BiennialReportWork_OH_GM2
SELECT DISTINCT
...
FROM EQ_Extract..BiennialReportWork_OH_GM1 GM1
...
INSERT EQ_Extract..BiennialReportWork_OH_GM4
SELECT DISTINCT
...
from
	EQ_Extract..BiennialReportWork_OH_GM1 GM1
...
--declare @intcounter int
set @intcounter = 0
update EQ_Extract..BiennialReportWork_OH_GM4
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_OH_GM] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_OH_GM] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_OH_GM] TO [EQAI]
    AS [dbo];
