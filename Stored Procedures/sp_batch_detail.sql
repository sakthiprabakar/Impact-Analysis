CREATE PROCEDURE sp_batch_detail
	@company_id			int
,	@profit_ctr_id		int
,	@date_from			datetime
,	@date_to			datetime
...
/************************************************************************************************************  
 ...
 PB object : r_batch_detail
 
 Loaded to Plt_AI

12/03/2010 SK	Created New on Plt_AI

sp_batch_detail 21, 0, '11/16/2005', '11/16/2005', '701', '12417'
************************************************************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_batch_detail] TO [EQAI]
    AS [dbo];
