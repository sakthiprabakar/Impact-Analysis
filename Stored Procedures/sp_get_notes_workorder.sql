...
create procedure sp_get_notes_workorder ( @workorder int, @profit_ctr int, @company int, @customer int, @generator int, @profile_list varchar(8000), @topics varchar(255) )
as


/***************************************************************************************
Returns notes for a given workorder record
...
Loads on PLT_AI*
Test Cmd Line: sp_get_notes 'Workorder',14,12,0,0,1,'','',0,0,121,0,0,'',0,0,'ADAM_G',''
****************************************************************************************/
...
SELECT  Note.note_id  ,
    ...
    FROM Note
   WHERE Note.workorder_id = @workorder
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_get_notes_workorder] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_get_notes_workorder] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_get_notes_workorder] TO [EQAI]
    AS [dbo];
