/***************************************************************************************
returns a list of customers referenced in notes in manage mode - runs a passed in query (the top-level manage query) and then filters it.
...
****************************************************************************************/
create procedure spw_managenotes_listcustomers
	@query varchar(7500),
	@page int,
	@recsperpage int,
	@parent_ID	int,
...
as
	...
	set nocount off
		...
		select @searchsql = 'select 
			...
			END
			from customer, customernote, #tempitems t (nolock)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_managenotes_listcustomers] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_managenotes_listcustomers] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_managenotes_listcustomers] TO [EQAI]
    AS [dbo];
