-- 
drop proc if exists sp_cor_receipt_service_lpx
go

create procedure sp_cor_receipt_service_lpx (
...
/* *******************************************************************
sp_cor_receipt_service_lpx
drop procedure sp_cor_receipt_service_lpx
...
exec sp_cor_receipt_service_lpx
...
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_receipt_service_lpx] TO [EQAI]
    AS [dbo];
GO

GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_receipt_service_lpx] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_receipt_service_lpx] TO [COR_USER]
    AS [dbo];
