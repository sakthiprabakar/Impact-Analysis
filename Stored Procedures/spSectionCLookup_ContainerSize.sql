...
BEGIN
	...
	-- RQ -UN/NA #
		   ...
		   SELECT bill_unit_code, bill_unit_desc,'T' is_bill_unit_table_lookup FROM BillUnit WHERE container_flag = 'T' AND disposal_flag = 'T'
		   AND (bill_unit_code LIKE '%'+@searchText+'%' OR bill_unit_desc LIKE '%'+@searchText+'%') AND manifest_unit IS NULL
...
GRANT EXEC ON [dbo].[spSectionCLookup_ContainerSize] TO COR_USER;
