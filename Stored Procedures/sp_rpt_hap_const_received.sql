DROP PROCEDURE IF EXISTS sp_rpt_hap_const_received
GO

CREATE PROCEDURE sp_rpt_hap_const_received
	@company_id			int
,	@profit_ctr_id		int
,	@date_from			datetime
,	@date_to			datetime
...
AS
/***********************************************************************
This procedure runs for the new report:  HAP Constituents Received Worksheet. GEM#37074

PB Object(s): r_hap_const_recvd_worksheet

This report was copied from the existing HAP report and has similar logic in it.  
however this report does not perform any rolling totals calculations.

04/11/2016 PRK/SK	Created by Paul - Reviewed finalized by Smita
03/11/2022 AM DevOps:17098 - Added 'ug/kg', 'ppb' and 'ug/L' calculation
04/18/2022 MPM		DevOps 27263 - Corrected the calculation of emissions.
...
sp_rpt_hap_const_received 26, 0, '07/31/2014', '07/31/2015', 'ALL' , -99, -99
sp_rpt_hap_const_received 21, 0, '01/1/2016', '03/31/2016', 'ALL' , -99, -99
sp_rpt_hap_const_received 32, 0, '01/1/2016', '03/31/2016', 'ALL' , -99, -99
***********************************************************************/
...
JOIN Constituents
	...
	AND (Constituents.ddvoc = 'T' or Constituents.hap = 'T')
...
/*	MPM - 4/18/2022 - DevOps 27263 - Corrected the calculation of pounds_emission.  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_hap_const_received] TO [EQAI]
    AS [dbo];
