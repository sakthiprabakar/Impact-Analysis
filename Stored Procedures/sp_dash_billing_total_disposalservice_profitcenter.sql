...
CREATE PROCEDURE sp_dash_billing_total_disposalservice_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
/************************************************************
Procedure    : sp_dash_billing_total_disposalservice_profitcenter
Database     : PLT_AI
...
sp_dash_billing_total_disposalservice_profitcenter 
    @StartDate='2009-09-01 00:00:00',
    @EndDate='2009-09-15 23:59:59',
    @user_code='JONATHAN',
    @contact_id=-1,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_disposalservice_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_disposalservice_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_disposalservice_profitcenter] TO [EQAI]
    AS [dbo];
