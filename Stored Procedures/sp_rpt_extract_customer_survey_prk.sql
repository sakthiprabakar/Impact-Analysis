...
CREATE PROCEDURE sp_rpt_extract_customer_survey_prk
...
/* ***********************************************************
Procedure    : sp_rpt_extract_customer_survey_prk
Database     : PLT_AI
Created      : Jan 15 2009 - Jonathan Broome
Description  : Returns Customer Survey information for the web site

Examples:
	sp_rpt_extract_customer_survey_prk '2,3,12,14,15,17,18,21,22,23,24,25,26,27,28,29,32', '12/1/2012 00:00', '12/8/2012 23:59' -- 0:17s 838 rows.
	sp_rpt_extract_customer_survey_prk '14', '7/1/2008 00:00', '7/8/2008 23:59' -- 0:10s, 60 rows.
--BEFORE
	sp_rpt_extract_customer_survey_prk 'All', '7/1/2015 00:00', '7/7/2015 23:59' -- 0:16s, 625 rows.
	sp_rpt_extract_customer_survey_prk 'All', '5/1/2016 00:00', '5/31/2016 23:59' -- 3:36s, 19087 rows.
--AFTER
	sp_rpt_extract_customer_survey_prk 'All', '7/1/2015 00:00', '7/7/2015 23:59' -- 0:23s, 831 rows.
	sp_rpt_extract_customer_survey_prk 'All', '5/1/2016 00:00', '5/31/2016 23:59' -- 2:10s, 28056 rows.
History:
	...
	01/15/2009 - JPB - Revised to run off PLT_AI, not each #'d database.
		...
		Renamed from sp_web_cust_survey_export to sp_rpt_extract_customer_survey_prk to match other extracts
...
--		, Contacts.qry_order
	...
	WHERE 1=1
		...
		AND Billing.workorder_resource_type IN ('E', 'G', 'L')
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_customer_survey_prk] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_customer_survey_prk] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_customer_survey_prk] TO [EQAI]
    AS [dbo];
