-- DROP PROCEDURE [dbo].[sp_COR_Profile_Approve_Count]
GO

CREATE PROCEDURE [dbo].[sp_COR_Profile_Approve_Count]
...
AS
/* *************************************************************************
sp_COR_Profile_Approve_Count

History:

	10/15/2019	MPM	DevOps 11580: Added logic to filter the result set
...
sp_COR_Profile_Approve_Count 
	...
	, @page					= null
	, @perpage				= null
	, @customer_id_list		= '20042'
    , @generator_id_list	= '158725'  
...
************************************************************************* */
	...
	where display_status IN ('Approved','Renewal')
...
grant execute on sp_COR_Profile_Approve_Count to eqweb,COR_USER
go
