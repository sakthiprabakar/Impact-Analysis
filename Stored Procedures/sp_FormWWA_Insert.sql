...
--/************************************************************
--Procedure	: sp_FormWWA_Insert
--Database	: PLT_AI*
--Created		: 5-10-2004 - Jonathan Broome
--Description	: Inserts waste information
--			  into the FormWWA table.
--************************************************************/
--Create Procedure sp_FormWWA_Insert (
--@form_id						int,
--@revision_id					int,
--@group_id						int				= NULL,
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormWWA_Insert] TO [EQWEB]
--    AS [dbo];
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormWWA_Insert] TO [COR_USER]
--    AS [dbo];
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormWWA_Insert] TO [EQAI]
--    AS [dbo];
