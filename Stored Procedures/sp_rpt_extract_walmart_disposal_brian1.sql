...
CREATE PROCEDURE sp_rpt_extract_walmart_disposal_brian1 (
	@start_date				datetime,
	@end_date				datetime,
...
/* ***********************************************************
	...
	sp_rpt_extract_walmart_disposal_brian1 '1/1/2009 00:00', '1/31/2009 23:59', 'validation'
	sp_rpt_extract_walmart_disposal_brian1 '1/1/2009 00:00', '1/31/2009 23:59', 'wm-extract'
	
	sp_rpt_extract_walmart_disposal_brian1 '10/1/2008 00:00', '9/30/2009 23:59', 'eq-extract'
...
-- Update Run information
 ...
 -- This is the default select
		...
		SELECT
			...
			generator_name,
			generator_id,
			approval_or_resource AS approval,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal_brian1] TO [EQAI]
    AS [dbo];
