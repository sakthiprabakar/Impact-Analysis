Drop Proc If Exists 	sp_annual_nonhaz_report_output_extract_IL
go
CREATE PROCEDURE sp_annual_nonhaz_report_output_extract_IL (
	@biennial_id	int,
...
SELECT distinct biennial_id FROM EQ_Extract..ILAnnualNonHazReport SD
			
sp_annual_nonhaz_report_output_extract_IL 1731, 'REPORT'

SELECT * FROM eq_temp..sp_annual_nonhaz_report_output_extract_IL

sp_annual_nonhaz_report_output_extract_IL 1719, 'HAULERS'
...
if @report_type = 'REPORT' begin
	...
	-- if object_id('eq_temp..sp_annual_nonhaz_report_output_extract_IL') is not null drop table eq_temp..sp_annual_nonhaz_report_output_extract_IL
	delete from eq_temp..sp_annual_nonhaz_report_output_extract_IL
	insert eq_temp..sp_annual_nonhaz_report_output_extract_IL
	SELECT DISTINCT
	...
	,	RIGHT(space(10) + ISNULL(convert(varchar(10), convert(numeric(10,1), SUM(
	...
	-- INTO eq_temp..sp_annual_nonhaz_report_output_extract_IL
...
if @report_type = 'HAULERS' begin
	...
	-- if object_id('eq_temp..sp_annual_nonhaz_report_output_hauler_IL') is not null drop table eq_temp..sp_annual_nonhaz_report_output_hauler_IL
	delete from eq_temp..sp_annual_nonhaz_report_output_hauler_IL
	insert eq_temp..sp_annual_nonhaz_report_output_hauler_IL
	SELECT DISTINCT
	...
	-- INTO eq_temp..sp_annual_nonhaz_report_output_hauler_IL
	FROM EQ_Extract..ILAnnualNonHazReport SD
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_annual_nonhaz_report_output_extract_IL] TO [EQWEB]

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_annual_nonhaz_report_output_extract_IL] TO [COR_USER]


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_annual_nonhaz_report_output_extract_IL] TO [EQAI]
