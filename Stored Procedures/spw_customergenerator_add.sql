...
/-***************************************************************************************
Creates a Customer-Generator relationship

09/15/2003 JPB	Created
01/07/2005 JPB  Altered to handle generator_id
Test Cmd Line: spw_customergenerator_add '123456789012', 2222, 'jonathan'
****************************************************************************************-/
create procedure spw_customergenerator_add
	@generator_id	int,
	@customer_ID	int,
	@by	varchar(10)
as
	...
	if @num = 0
	begin
		insert into customergenerator (generator_id, customer_ID, added_from_company, added_by, date_added) values (@generator_id, @customer_ID, 2, @by, getdate())
		declare @noteID int
		declare @Changes varchar(1000)
		set @Changes = 'Generator_ID: ' + @generator_id + ' added to Customer_ID: ' + convert(varchar(10), @Customer_ID)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_customergenerator_add] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_customergenerator_add] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spw_customergenerator_add] TO [EQAI]
    AS [dbo];
