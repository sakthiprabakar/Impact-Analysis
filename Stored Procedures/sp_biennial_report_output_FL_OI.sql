...
CREATE PROCEDURE sp_biennial_report_output_FL_OI (
	@biennial_id	int
)
AS
/* **********************************************************************************
...
DELETE FROM EQ_Extract..BiennialReportWork_FL_OI where biennial_id = @biennial_id


INSERT BiennialReportWork_FL_OI
SELECT DISTINCT
...
set @intcounter = 0
update BiennialReportWork_FL_OI
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_OI] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_OI] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_OI] TO [EQAI]
    AS [dbo];
