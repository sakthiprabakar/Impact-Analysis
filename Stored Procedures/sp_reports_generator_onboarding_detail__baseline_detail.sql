...
create proc sp_reports_generator_onboarding_detail__baseline_detail (
	@generator_id		int
  , @customer_id_list varchar(max)=''  /* Added 2019-07-25 by AA */
  , @generator_id_list varchar(max)='' /* Added 2019-07-25 by AA */
)
as
/* ****************************************************************************
sp_reports_generator_onboarding_detail__baseline_detail
...
sp_reports_generator_onboarding_detail__baseline_detail 168770
**************************************************************************** */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__baseline_detail] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__baseline_detail] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__baseline_detail] TO [EQAI]
    AS [dbo];
