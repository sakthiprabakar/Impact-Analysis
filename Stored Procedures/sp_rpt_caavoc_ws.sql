DROP PROCEDURE IF EXISTS [dbo].[sp_rpt_caavoc_ws]
GO

CREATE PROCEDURE sp_rpt_caavoc_ws
	@company_id		int
,	@profit_ctr_id	int
,	@date_from		datetime
,	@date_to		datetime
...
02/15/2015 AM   This is new sp created. This is replica of sp_rpt_ccvoc_ws, but get value of calculate CAAvoc.
05/12/2022 MPM	DevOps 27248 - Modified the calculation of emissions to be the same as in the HAP Report (DevOps 17534).
06/28/2022 GDE  DevOps 42727 - CAA VOC Worksheet - Report update
7/26/2023 Dipankar DevOps 50330 - Fixing DBA Observaations 
...
sp_rpt_caavoc_ws 21, 0, '02-01-2015', '02-18-2015', 888880, 888880
sp_rpt_caavoc_ws 21, 0, '12-31-2013', '12-31-2014', 888880, 888880
sp_rpt_caavoc_ws 21, 0, '1-4-2022', '1-5-2022', 1347, 1347
****************************************************************************************/
...
--,	ROUND((r.caavoc/1000000), 8) AS VOC
,   Round ( dbo.fn_calculate_constituents_caavoc (r.company_id,r.profit_ctr_id,r.receipt_id,r.line_id ) /1000000 , 8  ) as CAAVOC
...
UPDATE #tmp SET tons_voc = ROUND((pounds * CAAVOC * @pound_ton_conversion), 8)
...
-- Get values from new ProfitCenterCCVOCDDVOHAP 
 ...
 /*	MPM - 5/12/2022 - DevOps 27248 - Modified the calculation of emissions to be the same as in the HAP Report (DevOps 17534).  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_caavoc_ws] TO [EQAI]
    AS [dbo];
