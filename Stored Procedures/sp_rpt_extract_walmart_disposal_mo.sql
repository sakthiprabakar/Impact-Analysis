...
CREATE PROCEDURE sp_rpt_extract_walmart_disposal_mo (
	@start_date				datetime,
	@end_date				datetime,
...
AS
/* ***********************************************************
Procedure    : sp_rpt_extract_walmart_disposal_mo
Database     : PLT_AI
Created      : Jan 25 2008 - Jonathan Broome
Description  : Creates a Wal-Mart Disposal Extract

Examples:
	sp_rpt_extract_walmart_disposal_mo '1/1/2009 00:00', '1/31/2009 23:59', 'validation'
	sp_rpt_extract_walmart_disposal_mo '10/1/2008 00:00', '10/31/2008 23:59', 'wm-extract'
...
History:
	...
	07/17/2009 - JPB
		GEM:12929:
			Per Walmart Corporate Email Request:
			Please generate Waste Extract for state of Missouri only. 
			Include service dates of January 1, 2009 - June 30, 2009.
			Waste Extract should include all waste data from:Sams Clubs, Walmart, 
			Walmart Supercenter, Walmart Neighborhood Market, Walmart Optical Lab, 
			and Walmart Return Center, Walmart PDMC in the state of Missouri
		- Note the inferred inclusion of non-bucket-program data.
		- Note that NWP records aren't needed here (removed the query)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal_mo] TO [EQAI]
    AS [dbo];
