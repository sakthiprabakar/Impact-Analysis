CREATE PROCEDURE [dbo].[sp_BaselineDetailSelectForBaselineAndGenerator] 
    @baseline_id INT,
    @generator_id int
AS 
	SET NOCOUNT ON 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_BaselineDetailSelectForBaselineAndGenerator] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_BaselineDetailSelectForBaselineAndGenerator] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_BaselineDetailSelectForBaselineAndGenerator] TO [EQAI]
    AS [dbo];
