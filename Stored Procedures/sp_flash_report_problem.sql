CREATE PROCEDURE sp_flash_report_problem 
	@company_id		int
,	@profit_ctr_id	int
,	@date_from 		datetime
,	@date_to		datetime
...
Filename:	L:\Apps\SQL\EQAI\sp_flash_report_problem.sql
PB Object(s):	d_rpt_flash_report_problem
...
sp_flash_report_problem 14, -1, '3-01-2007 00:00:00','5-10-2007 23:59:59', 1, 999999, '99', 1
****************************************************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_flash_report_problem] TO [EQAI]
    AS [dbo];
