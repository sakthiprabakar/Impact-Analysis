...
CREATE PROCEDURE sp_rpt_batch_reagents_location_summary_report
	@company_id		int
,	@profit_ctr_id 	int
,	@date_from		datetime
,	@date_to		datetime
AS
/***************************************************************************************
r_batch_reagents_location_summary_report

05/2/2018 AM	Created

sp_rpt_batch_reagents_location_summary_report 45, 0,  '1/1/2018', '3/1/2018'
...
--Batch Reagents Used - Summary by batch location
...
where 
	...
	and b.status <> 'V'
group by b.location, be.reagent_desc, be.unit, bu.pound_conv
order by b.location, be.reagent_desc


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_batch_reagents_location_summary_report] TO [EQAI]
    AS [dbo];
