...
CREATE PROCEDURE sp_biennial_report_output_FL_WR (
	@biennial_id	int
)
AS
/* **********************************************************************************
...
DELETE FROM EQ_Extract..BiennialReportWork_FL_WR1 where biennial_id = @biennial_id

INSERT EQ_Extract..BiennialReportWork_FL_WR1
SELECT DISTINCT
	...
	LEFT(SD.EPA_FORM_CODE + space(4), 4) as FORM_CODE,
		-- Form Code 
		-- Starts at column: 19
		-- Field length: 4
		-- Data type: Alphanumeric
	...
	SD.management_code as MANAGEMENT_METHOD,
		-- Management Method 
		-- Starts at column: 32
		-- Field length: 4
		-- Data type: Alphanumeric
...
set @intcounter = 0
update EQ_Extract..BiennialReportWork_FL_WR1
...
DELETE FROM EQ_Extract..BiennialReportWork_FL_WR2 where biennial_id = @biennial_id

INSERT EQ_Extract..BiennialReportWork_FL_WR2
SELECT DISTINCT
...
FROM EQ_Extract..BiennialReportWork_FL_WR1 WR1
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_WR] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_WR] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_biennial_report_output_FL_WR] TO [EQAI]
    AS [dbo];
