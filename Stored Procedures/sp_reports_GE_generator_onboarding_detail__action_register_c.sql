...
create proc sp_reports_GE_generator_onboarding_detail__action_register_c (
	@generator_id		int
	, @status_list		varchar(max) = 'all'
)
as
/* ****************************************************************************
sp_reports_GE_generator_onboarding_detail__action_register_c
...
sp_reports_GE_generator_onboarding_detail__action_register_c 169151
**************************************************************************** */
...
union select distinct status from ActionRegister where @status_list = 'all'
	...
	--                ar.generator_id AS 'generator_id',
		...
		arit.incident_type AS 'incident_type',
	...
	LEFT OUTER JOIN ActionRegisterIncidentType arit
		ON arit.incident_type_id = ar.incident_type_id
	WHERE art.action_type = 'Incident'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_c] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_c] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_c] TO [EQAI]
    AS [dbo];
