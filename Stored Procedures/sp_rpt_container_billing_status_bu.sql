...
CREATE PROC sp_rpt_container_billing_status_bu (
	@start_date			datetime
	, @end_date			datetime
...
sp_rpt_container_billing_status_bu
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_container_billing_status_bu] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_container_billing_status_bu] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_container_billing_status_bu] TO [EQAI]
    AS [dbo];
