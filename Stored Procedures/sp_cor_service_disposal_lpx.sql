-- region sp_cor_service_disposal_lpx
--
drop proc if exists sp_cor_service_disposal_lpx
go
create procedure sp_cor_service_disposal_lpx (
...
/* *******************************************************************
sp_cor_service_disposal_lpx

sp_helptext sp_cor_service_disposal_lpx
...
exec sp_cor_service_disposal_lpx_list
	@web_userid = 'dcrozier@riteaid.com'
	, @workorder_id = 21374000
	, @company_id = 14
	, @profit_ctr_id = 0

exec sp_cor_service_disposal_lpx
	@web_userid = 'dcrozier@riteaid.com'
	, @workorder_id = 21374000
	, @company_id = 14
	, @profit_ctr_id = 0
...
grant execute on sp_cor_service_disposal_lpx to eqai, eqweb, COR_USER
go
