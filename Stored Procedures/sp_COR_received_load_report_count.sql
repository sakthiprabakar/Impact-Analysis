-- drop proc sp_COR_received_load_report_count
go
create proc sp_COR_received_load_report_count (
...
10/09/2019	DevOps:11594 - AM - Added customer_id and generator_id temp tables and added receipt join.
...
[sp_COR_received_load_report_count] 
...
GO
GRANT EXECUTE ON [dbo].[sp_COR_received_load_report_count] TO COR_USER;
GO