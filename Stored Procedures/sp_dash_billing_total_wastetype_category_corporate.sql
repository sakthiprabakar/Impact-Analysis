...
CREATE PROCEDURE sp_dash_billing_total_wastetype_category_corporate (
    @StartDate  datetime,
    @EndDate    datetime,
...
AS
/************************************************************
Procedure    : sp_dash_billing_total_wastetype_category_corporate
Database     : PLT_AI
...
sp_dash_billing_total_wastetype_category_corporate
...
sp_helptext sp_dash_billing_total_wastetype_category_corporate    
************************************************************/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_corporate] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_corporate] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_corporate] TO [EQAI]
    AS [dbo];
