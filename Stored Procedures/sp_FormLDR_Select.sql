...
--/************************************************************
--Procedure	: sp_FormLDR_Select
--Database	: PLT_AI*
--Created		: 5-10-2004 - Jonathan Broome
--Description	: Selects FormLDR records for the
--			  matching form_id + revision_id.
--************************************************************/
--Create Procedure sp_FormLDR_Select (
--@form_id							int,
--@revision_id						int,
--@group_id							int = NULL,
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormLDR_Select] TO [EQWEB]
--    AS [dbo];
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormLDR_Select] TO [COR_USER]
--    AS [dbo];
...
--GO
--GRANT EXECUTE
--    ON OBJECT::[dbo].[sp_FormLDR_Select] TO [EQAI]
--    AS [dbo];
