...
if exists (select 1 from sysobjects where type = 'P' and name = 'sp_labpack_sync_get_profiletemplate')
	drop procedure sp_labpack_sync_get_profiletemplate
go

create procedure [dbo].[sp_labpack_sync_get_profiletemplate]
...
/***************************************************************************************
 ...
 06/04/2021 - rb created
 08/03/2021 - rb added LDR underlined_text and regular_text
 09/08/2022 - rb ADO 50019 - added dbo.fn_get_label_default_type() (this was returning an empty string)

 EXEC sp_labpack_sync_get_profiletemplate
 EXEC sp_labpack_sync_get_profiletemplate '06/10/2021 12:34:56'
...
select distinct
	...
	dbo.fn_get_label_default_type ('P', p.profile_id, 0, 0, 0, 0) label_type,
	p.process_code_uid,
...
and (p.date_added > coalesce(@last_sync_dt,'01/01/2000') or p.date_modified > coalesce(@last_sync_dt,'01/01/2000'))
go

grant execute on sp_labpack_sync_get_profiletemplate to eqai
go
