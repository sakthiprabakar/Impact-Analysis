...
create proc sp_reports_GE_generator_baseline_master (
...
as
/* ****************************************************************************
sp_reports_GE_generator_baseline_master
...
As sp_reports_GE_generator_baseline_master, all it has to do is return generator_id.


exec sp_reports_GE_generator_baseline_master
	@ReportType				= 'detail'	--'All'
	, @customer_id_list		= '-1'
	, @generator_id_list	= '117871'
	, @site_type_list	= 'GE Additive, GE Aviation, GE Capital, GE Digital, GE Energy Connections, GE Healthcare, GE Lighting, GE Oil & Gas, GE Transportation'
...
if 1=0 begin
	...
	declare @n int
	exec @n = sp_message_insert 'sp_reports_GE_generator_baseline_master params', @dbgInfo, '', 'JONATHAN', '', NULL, NULL, NULL
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_baseline_master] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_baseline_master] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_baseline_master] TO [EQAI]
    AS [dbo];
