...
create proc sp_reports_GE_generator_onboarding_detail__action_register_status_summary (
	@generator_id		int
)
as
/* ****************************************************************************
sp_reports_GE_generator_onboarding_detail__action_register_status_summary

Simple return of status info for action register for a specific generator

sp_reports_GE_generator_onboarding_detail__action_register_status_summary 169151
**************************************************************************** */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_status_summary] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_status_summary] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__action_register_status_summary] TO [EQAI]
    AS [dbo];
