...
CREATE PROCEDURE sp_dash_containers_receipt_num_new_status
	@measurement_id	int,
	@until_date		datetime = NULL
AS
/* ************************************************
sp_dash_containers_receipt_num_new_status:
	@measurement_id: 	The DashboardMeasurement record related to this test.

Total Number of Receipt containers with a status of New

select * from DashBoardMeasurement where description like '%con%'
-- 37

	sp_dash_containers_receipt_num_new_status 37, '2009-09-10 23:59:59'
	select * 
		from DashboardResult 
		where report_period_end_date = '2009-09-10 00:00:00.000'
		and measurement_id = 37
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_containers_receipt_num_new_status] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_containers_receipt_num_new_status] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_containers_receipt_num_new_status] TO [EQAI]
    AS [dbo];
