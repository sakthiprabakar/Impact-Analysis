Create Procedure SP_Opp_Search (
	@Debug					int = 0,
 ...
 ************************************************************
	...
	10/03/2011  JPB - Fix to the subquery for returning NAM name - was missing a join condition and returning wrong data.
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SP_Opp_Search] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SP_Opp_Search] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SP_Opp_Search] TO [EQAI]
    AS [dbo];
