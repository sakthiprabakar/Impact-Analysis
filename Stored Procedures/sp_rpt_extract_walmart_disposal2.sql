...
CREATE PROCEDURE sp_rpt_extract_walmart_disposal2 (
	@start_date				datetime,
	@end_date				datetime,
...
AS
/* ***********************************************************
Procedure    : sp_rpt_extract_walmart_disposal2
Database     : PLT_AI
Created      : Jan 25 2008 - Jonathan Broome
Description  : Creates a Wal-Mart Disposal Extract

Examples:
	sp_rpt_extract_walmart_disposal2 '1/1/2009 00:00', '1/31/2009 23:59', 'validation'
	sp_rpt_extract_walmart_disposal2 '6/1/2009 00:00', '6/30/2009 23:59', 'eq-extract'
	sp_rpt_extract_walmart_disposal2 '6/1/2009 00:00', '6/30/2009 23:59', 'wm-extract'
	...
	WHERE
		...
		SELECT
			...
			CASE WHEN waste_desc = 'No waste picked up' THEN
				REPLACE(ISNULL(CONVERT(varchar(20), service_date, 101), ''), '/', '')
			ELSE
				ISNULL(manifest, '') 
			...
			disposal_service_desc as 'Disposal Method'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_disposal2] TO [EQAI]
    AS [dbo];
