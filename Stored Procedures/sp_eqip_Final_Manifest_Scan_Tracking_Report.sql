-- if exists (select 1 from sysobjects where name = 'sp_eqip_Final_Manifest_Scan_Tracking_Report') drop proc sp_eqip_Final_Manifest_Scan_Tracking_Report
Go

Create Proc sp_eqip_Final_Manifest_Scan_Tracking_Report (
	@customer_id int		
	, @start_date_start	datetime
	, @start_date_end	datetime
	, @days_past_service_date int
) as

/* ***********************************************************************
sp_eqip_Final_Manifest_Scan_Tracking_Report

sp_eqip_Final_Manifest_Scan_Tracking_Report
	 @customer_id 		= 15622
	, @start_date_start	= '7/1/2019'
	, @start_date_end	= '12/31/2019 23:59'
	, @days_past_service_date  = 7
...
grant execute on sp_eqip_Final_Manifest_Scan_Tracking_Report to eqai
go
grant execute on sp_eqip_Final_Manifest_Scan_Tracking_Report to eqweb
go
grant execute on sp_eqip_Final_Manifest_Scan_Tracking_Report to cor_user
go
