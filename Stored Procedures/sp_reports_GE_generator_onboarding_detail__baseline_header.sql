...
create proc sp_reports_GE_generator_onboarding_detail__baseline_header (
	@generator_id		int
)
as
/* ****************************************************************************
sp_reports_GE_generator_onboarding_detail__baseline_header
...
sp_reports_GE_generator_onboarding_detail__baseline_header 168770
**************************************************************************** */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__baseline_header] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__baseline_header] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__baseline_header] TO [EQAI]
    AS [dbo];
