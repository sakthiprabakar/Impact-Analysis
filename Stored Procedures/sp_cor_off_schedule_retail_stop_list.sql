-- drop proc sp_cor_off_Schedule_retail_stop_list
go

create proc sp_cor_off_Schedule_retail_stop_list (
...
/* *************************************************************************
sp_cor_off_Schedule_retail_stop_list
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_off_Schedule_retail_stop_list] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_off_Schedule_retail_stop_list] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_cor_off_Schedule_retail_stop_list] TO [EQAI]
    AS [dbo];
