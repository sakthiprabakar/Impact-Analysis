...
CREATE PROCEDURE sp_dash_volume_total_treatmentprocess_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
AS
/************************************************************
Procedure    : sp_dash_volume_total_treatmentprocess_profitcenter
Database     : PLT_AI
...
sp_dash_volume_total_treatmentprocess_profitcenter 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_treatmentprocess_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_treatmentprocess_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_treatmentprocess_profitcenter] TO [EQAI]
    AS [dbo];
