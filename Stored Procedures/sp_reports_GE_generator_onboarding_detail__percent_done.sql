...
create proc sp_reports_GE_generator_onboarding_detail__percent_done (
	@generator_id		int
)
as
/* ****************************************************************************
...
sp_reports_GE_generator_onboarding_detail__percent_done 168770
**************************************************************************** */
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__percent_done] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__percent_done] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_onboarding_detail__percent_done] TO [EQAI]
    AS [dbo];
