...
create proc sp_reports_generator_baseline_report (
...
exec sp_reports_generator_baseline_report
	@customer_id		= -1
	, @generator_id	= -1
	, @site_type_list	= ''
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_baseline_report] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_baseline_report] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_baseline_report] TO [EQAI]
    AS [dbo];
