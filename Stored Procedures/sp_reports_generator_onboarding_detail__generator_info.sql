...
create proc sp_reports_generator_onboarding_detail__generator_info (
	@generator_id		int
)
as
/* ****************************************************************************
sp_reports_generator_onboarding_detail__generator_info
...
sp_reports_generator_onboarding_detail__generator_info 169151
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__generator_info] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__generator_info] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_generator_onboarding_detail__generator_info] TO [EQAI]
    AS [dbo];
