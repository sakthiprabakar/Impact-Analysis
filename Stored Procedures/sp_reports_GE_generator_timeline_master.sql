...
create proc sp_reports_GE_generator_timeline_master (
...
as
/* ****************************************************************************
sp_reports_GE_generator_timeline_master
...
As sp_reports_GE_generator_timeline_master, all it has to do is return generator_id.


exec sp_reports_GE_generator_timeline_master
	@customer_id_list		= '-1'
	, @generator_id_list	= '-1'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_timeline_master] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_timeline_master] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_GE_generator_timeline_master] TO [EQAI]
    AS [dbo];
