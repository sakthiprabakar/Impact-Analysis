...
CREATE PROCEDURE sp_retail_email_order_confirm (
	@order_id	int )
AS
/* **************************************************************
Loads to:	Plt_AI
...
sp_retail_email_order_confirm 1066
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_retail_email_order_confirm] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_retail_email_order_confirm] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_retail_email_order_confirm] TO [EQAI]
    AS [dbo];
