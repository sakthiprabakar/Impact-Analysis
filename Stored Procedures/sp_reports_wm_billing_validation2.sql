CREATE PROCEDURE sp_reports_wm_billing_validation2
	@StartDate datetime,
	@EndDate datetime,
...
/* ******************************************************************************
	exec sp_reports_wm_billing_validation2 
		@StartDate='2012-04-01 00:00:00',
		@EndDate='2012-04-30 00:00:00',
...
-- 779120 Xmatching units.
	...
	2012-05-30 JPB - Added 2 new validation checks for Receipt & Workorder record conditions that the post-invoice
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_wm_billing_validation2] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_wm_billing_validation2] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_reports_wm_billing_validation2] TO [EQAI]
    AS [dbo];
