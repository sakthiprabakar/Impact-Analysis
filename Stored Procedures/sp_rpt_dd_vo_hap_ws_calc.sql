DROP PROCEDURE IF EXISTS [dbo].[sp_rpt_dd_vo_hap_ws_calc]
GO
CREATE PROCEDURE [dbo].[sp_rpt_dd_vo_hap_ws_calc]
	@company_id		int
,	@profit_ctr_id	int
,	@date_from		datetime
,	@date_to		datetime
...
07/14/2015 SK	Renamed the sp to sp_rpt_dd_vo_hap_ws_calc. This will be used as a calculated version. The value for DD VO HAP 
				will not be taken from profile but will be system calculated.
06/28/2022 GDE  42739 - DD VO HAP Worksheet (Calculated) - Report update
04/21/2023 MPM	DevOps 27259 - Modified the calcuation of pounds_emission so that it's done in the same way as was done to the 
				HAP Report under DevOps 17354.
07/06/2023 Dipankar DevOps 65983 Performance Improvement Changes made as per Blair's Observations, avoided UNION Query and Row by Row Operation
08/01/2023 Dipankar - DevOps 50330 - Implemented DBA Observation comments

sp_rpt_dd_vo_hap_ws_calc 2, 0,'6-1-2013', '06-30-2014', 1, 999999
sp_rpt_dd_vo_hap_ws_calc 22, 0,'1-1-2013', '1-3-2013', 1, 999999
sp_rpt_dd_vo_hap_ws_calc  21, 0, '10-01-2010', '10-03-2010', 0, 200000
sp_rpt_dd_vo_hap_ws_calc 21, 0,'1-14-2014', '1-14-2014', 1, 999999
****************************************************************************************/
...
,   Round ( ( dbo.fn_calculate_constituents_ddvoc (tr.company_id, tr.profit_ctr_id, tr.receipt_id, tr.line_id) /1000000 ), 8  )  as DDVOC
...
--      END
 ...
 /*	MPM - 4/21/2023 - DevOps 27259 - Modified the calculation of emissions to be the same as in the HAP Report (DevOps 17534).  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_dd_vo_hap_ws_calc] TO [EQAI];
