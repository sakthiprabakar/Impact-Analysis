...
CREATE PROCEDURE sp_dash_volume_total_product_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
AS
/************************************************************
Procedure    : sp_dash_volume_total_product_profitcenter
Database     : PLT_AI
Created      : Sep 3, 2009 - Jonathan Broome
Description  : Returns the total volume per product across all companies
...
sp_dash_volume_total_product_profitcenter
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_product_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_product_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_product_profitcenter] TO [EQAI]
    AS [dbo];
