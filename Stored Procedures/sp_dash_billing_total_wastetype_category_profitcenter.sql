...
CREATE PROCEDURE sp_dash_billing_total_wastetype_category_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
/************************************************************
Procedure    : sp_dash_billing_total_wastetype_category_profitcenter
Database     : PLT_AI
...
sp_dash_billing_total_wastetype_category_profitcenter
 ...
 sp_helptext sp_dash_billing_total_wastetype_category_profitcenter
************************************************************/
...
FROM   BILLING b
       INNER JOIN Receipt r
         ON b.receipt_id = r.receipt_id
            ...
            AND b.profit_ctr_id = r.profit_ctr_id
            AND b.line_id = r.line_id
       LEFT JOIN #weight_totals details WITH(NOLOCK)
...
WHERE  b.invoice_date BETWEEN @StartDate AND @EndDate
       AND b.status_code = 'I'
       AND pr.status = 'A'
       AND b.trans_source = 'R'
       AND b.trans_type = 'D'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_billing_total_wastetype_category_profitcenter] TO [EQAI]
    AS [dbo];
