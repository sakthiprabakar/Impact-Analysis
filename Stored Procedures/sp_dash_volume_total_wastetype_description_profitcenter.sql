...
CREATE PROCEDURE sp_dash_volume_total_wastetype_description_profitcenter (
    @StartDate  datetime,
    @EndDate    datetime,
...
AS
/************************************************************
Procedure    : sp_dash_volume_total_wastetype_description_profitcenter
Database     : PLT_AI
...
sp_dash_volume_total_wastetype_description_profitcenter 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_profitcenter] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_profitcenter] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_profitcenter] TO [EQAI]
    AS [dbo];
