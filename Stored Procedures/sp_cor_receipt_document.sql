-- drop proc sp_cor_receipt_document
go

CREATE procedure sp_cor_receipt_document (
...
/* *******************************************************************
sp_cor_receipt_document

Description
	Provides a listing of all receipt attachments

exec sp_cor_receipt_document
...
select
	...
	, company_id
	, profit_ctr_id
from dbo.fn_cor_scan_lookup (@i_web_userid, 'receipt', @i_receipt_id, @i_company_id, @i_profit_ctr_id, 1, '')
...
grant execute on sp_cor_receipt_document to eqai, eqweb, COR_USER
go
