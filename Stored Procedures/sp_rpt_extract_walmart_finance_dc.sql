...
CREATE PROCEDURE sp_rpt_extract_walmart_finance_dc (
	@start_date				datetime,
	@end_date				datetime,
...
AS
/* ***********************************************************
Procedure    : sp_rpt_extract_walmart_finance_dc
Database     : PLT_AI
Created      : Jan 25 2008 - Jonathan Broome
Description  : Creates a Wal-Mart Financial Extract

Examples:
	sp_rpt_extract_walmart_finance_dc '4/1/2009 00:00', '4/30/2009 23:59', 'validation'
	sp_rpt_extract_walmart_finance_dc '7/1/2008 00:00', '7/31/2008 23:59', 'validation'
	sp_rpt_extract_walmart_finance_dc '1/1/2011 00:00', '1/31/2011 23:59', 'wm-extract'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_rpt_extract_walmart_finance_dc] TO [EQAI]
    AS [dbo];
