...
CREATE PROCEDURE sp_dash_volume_total_wastetype_description_corporate (
    @StartDate  datetime,
    @EndDate    datetime,
...
AS
/************************************************************
Procedure    : sp_dash_volume_total_wastetype_description_corporate
Database     : PLT_AI
...
sp_dash_volume_total_wastetype_description_corporate
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_corporate] TO [EQWEB]
    AS [dbo];
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_corporate] TO [COR_USER]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_dash_volume_total_wastetype_description_corporate] TO [EQAI]
    AS [dbo];
